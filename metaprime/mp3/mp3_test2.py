...
prime_left = visual.GratingStim(win=win, tex = "sin", size = 3, sf = 0.75, ori = -45, contrast = 0.75, mask = 'gauss')
prime_right = visual.GratingStim(win=win, tex = "sin", size = 3, sf = 0.75, ori = 45, contrast = 0.75, mask = 'gauss')
mask_left= visual.GratingStim(win = win, tex = "sin", size = 4.5, sf = 0.75, ori = -45, contrast = 0.75, mask = 'circle')
mask_right = visual.GratingStim(win = win, tex = "sin", size = 4.5, sf = 0.75, ori = 45, contrast = 0.75, mask = 'circle')
