...
prime_text2 = visual.TextStim(win, text='This time, your task is to identify the orientation of the smaller grating. Try your best to ignore the interruption from the bigger grating.\n\n If you think the grating is oriented up-to-the-left, press X. If it is orientated up-to-the-right, press M.\n\nPress space to continue.', height = text_height, pos = pos_text, color = text_color)
prime_text3 = visual.TextStim(win, text='We will give you some easy practice trials first, feedback on corretness will be given after each trial.\n\nPress space to start the practice trial', height = text_height, pos = pos_text, color = text_color)
prime_text4 = visual.TextStim(win, text='Excellent! Now we will start the main experiment, no feedback on corretness will be given. The main task is more difficult than the practice trial. Please try you best!\n\nPress space to start the mian experiment', height = text_height, pos = pos_text, color = text_color)
